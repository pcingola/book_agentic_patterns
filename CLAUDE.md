...
**pyproject.toml**: Project metadata and dependencies. Key packages: pydantic-ai (>=1.39.0), chromadb (>=1.4.1), openai (>=2.14.0), fastmcp (>=2.14.2), fasta2a (>=0.6.0), requests (>=2.32.0), jsonpath-ng, pyyaml, dotenv, ipykernel. Console script: `doctors`.
