...
- [x] Chainlit
- [x] AGUI
- [x] Session propagation: MCP / A2A tracking
- [x] File uploads: Workspace and sampling the file (context management)
...
- [x] User feedback: Session thumb up/down, report errors, etc.
