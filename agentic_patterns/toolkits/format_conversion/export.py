...
def markdown_to(input_path: Path, output_path: Path, output_format: OutputFormat) -> Path:
    ...
    pypandoc.convert_file(str(input_path), fmt, outputfile=str(output_path), extra_args=extra_args)
    return output_path
