...
from agentic_patterns.toolkits.data_viz.io import load_df, save_figure
from agentic_patterns.toolkits.data_viz.models import PlotConfig
from agentic_patterns.toolkits.data_viz.ops_basic import BASIC_OPERATIONS
from agentic_patterns.toolkits.data_viz.ops_categorical import CATEGORICAL_OPERATIONS
from agentic_patterns.toolkits.data_viz.ops_distribution import DISTRIBUTION_OPERATIONS
from agentic_patterns.toolkits.data_viz.ops_matrix import MATRIX_OPERATIONS
...
async def execute_plot(
    ...
    try:
        ...
        plt.close("all")
        raise RuntimeError(f"Plot '{plot_name}' failed unexpectedly: {e}") from e
