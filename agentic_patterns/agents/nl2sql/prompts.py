...
def get_system_prompt() -> str:
    ...
    return load_prompt("sql/nl2sql/nl2sql_system_prompt")
...
def _load_specific_instructions(db_id: str, db_type: str) -> str | None:
    ...
    try:
        return load_prompt(f"sql/nl2sql/db_specific/{db_id}_instructions")
    except FileNotFoundError:
        pass
    try:
        return load_prompt(f"sql/nl2sql/db_type/{db_type}_instructions")
    except FileNotFoundError:
        return None
