...
def create_db_operations(db_id: str, connection: DbConnection | None = None) -> "DbOperations":
    ...
    match config.type:
        case DatabaseType.SQLITE:
            from agentic_patterns.core.connectors.sql.sqlite.operations import DbOperationsSqlite
