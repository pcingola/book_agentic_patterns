...
def register_tools(mcp: FastMCP) -> None:
    ...
    async def file_read(path: str, ctx: Context) -> str:
        ...
        return _call(FileConnector().read, path)
    ...
    async def file_write(path: str, content: str, ctx: Context) -> str:
        ...
        return _call(FileConnector().write, path, content)
    ...
    async def file_append(path: str, content: str, ctx: Context) -> str:
        ...
        return _call(FileConnector().append, path, content)
    ...
    async def file_delete(path: str, ctx: Context) -> str:
        ...
        return _call(FileConnector().delete, path)
    ...
    async def file_edit(
        ...
        return _call(FileConnector().edit, path, start_line, end_line, new_content)
    ...
    async def file_find(path: str, query: str, ctx: Context) -> str:
        ...
        return _call(FileConnector().find, path, query)
    ...
    async def file_head(path: str, n: int = 10, ctx: Context = None) -> str:
        ...
        return _call(FileConnector().head, path, n)
    ...
    async def file_tail(path: str, n: int = 10, ctx: Context = None) -> str:
        ...
        return _call(FileConnector().tail, path, n)
    ...
    async def file_list(path: str, pattern: str = "*", ctx: Context = None) -> str:
        ...
        return _call(FileConnector().list, path, pattern)
    ...
    async def csv_headers(path: str, ctx: Context) -> str:
        ...
        return _call(CsvConnector().headers, path)
    ...
    async def csv_head(path: str, n: int = 10, ctx: Context = None) -> str:
        ...
        return _call(CsvConnector().head, path, n)
    ...
    async def csv_tail(path: str, n: int = 10, ctx: Context = None) -> str:
        ...
        return _call(CsvConnector().tail, path, n)
    ...
    async def csv_read_row(path: str, row_number: int, ctx: Context) -> str:
        ...
        return _call(CsvConnector().read_row, path, row_number)
    ...
    async def csv_find_rows(
        ...
        return _call(CsvConnector().find_rows, path, column, value, limit)
    ...
    async def csv_append(
        ...
        return _call(CsvConnector().append, path, values)
    ...
    async def csv_delete_rows(
        ...
        return _call(CsvConnector().delete_rows, path, column, value)
    ...
    async def csv_update_cell(
        ...
        return _call(CsvConnector().update_cell, path, row_number, column, value)
    ...
    async def csv_update_row(
        ...
        return _call(CsvConnector().update_row, path, key_column, key_value, updates)
    ...
    async def json_get(path: str, json_path: str, ctx: Context) -> str:
        ...
        return _call(JsonConnector().get, path, json_path)
    ...
    async def json_set(path: str, json_path: str, value: str, ctx: Context) -> str:
        ...
        return _call(JsonConnector().set, path, json_path, value)
    ...
    async def json_keys(path: str, json_path: str = "$", ctx: Context = None) -> str:
        ...
        return _call(JsonConnector().keys, path, json_path)
    ...
    async def json_schema(
        ...
        return _call(JsonConnector().schema, path, json_path, max_depth)
    ...
    async def json_query(
        ...
        return _call(JsonConnector().query, path, json_path, max_results)
    ...
    async def json_head(
        ...
        return _call(JsonConnector().head, path, json_path, n)
    ...
    async def json_tail(
        ...
        return _call(JsonConnector().tail, path, json_path, n)
    ...
    async def json_validate(path: str, ctx: Context) -> str:
        ...
        return _call(JsonConnector().validate, path)
    ...
    async def json_append(path: str, json_path: str, value: str, ctx: Context) -> str:
        ...
        return _call(JsonConnector().append, path, json_path, value)
    ...
    async def json_delete_key(path: str, json_path: str, ctx: Context) -> str:
        ...
        return _call(JsonConnector().delete_key, path, json_path)
    ...
    async def json_merge(path: str, json_path: str, updates: str, ctx: Context) -> str:
        ...
        return _call(JsonConnector().merge, path, json_path, updates)
