...
1. Passing the inference profile ARN as the model name to BedrockConverseModel
1. Using the `profile` parameter to specify the logical model name for feature detection
