...
For details on how to set up authentication with this model, see [model configuration for xAI](https://ai.pydantic.dev/models/xai/index.md).
...
| ------------ | ------------------ | ---------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
| `model_name` | `XaiModelName`     | The name of the xAI model to use (e.g., "grok-4-1-fast-non-reasoning") | *required*                                                                                                  |
| `provider`   | \`Literal['xai']   | Provider[AsyncClient]\`                                                | The provider to use for API calls. Defaults to 'xai'.                                                       |
| `profile`    | \`ModelProfileSpec | None\`                                                                 | Optional model profile specification. Defaults to a profile picked by the provider based on the model name. |
| `settings`   | \`ModelSettings    | None\`                                                                 | Optional model settings.                                                                                    |
