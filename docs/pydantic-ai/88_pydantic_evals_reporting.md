...
class ReportCaseRenderer:
    ...
    def _render_assertions(
        ...
        lines: list[str] = []
        for a in assertions:
            line = '[green]âœ”[/]' if a.value else '[red]âœ—[/]'
    ...
    def _render_aggregate_assertions(
        ...
        return (
            default_render_percentage(assertions) + ' [green]âœ”[/]'
    ...
    def _render_assertions_diff(
        ...
        old = ''.join(['[green]âœ”[/]' if a.value else '[red]âœ—[/]' for a in assertions])
        new = ''.join(['[green]âœ”[/]' if a.value else '[red]âœ—[/]' for a in new_assertions])
        return old if old == new else f'{old} â†’ {new}'
    ...
    def _render_aggregate_assertions_diff(
        ...
        rendered_baseline = (
            default_render_percentage(baseline) + ' [green]âœ”[/]' if baseline is not None else EMPTY_CELL_STR
        )
        rendered_new = default_render_percentage(new) + ' [green]âœ”[/]' if new is not None else EMPTY_CELL_STR
        return rendered_new if rendered_baseline == rendered_new else f'{rendered_baseline} â†’ {rendered_new}'
