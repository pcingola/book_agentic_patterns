...
- [`pydantic-deep`](https://github.com/vstorm-co/pydantic-deepagents) â€” Deep agent framework that includes a `FilesystemToolset` with multiple backends (in-memory, real filesystem, Docker sandbox).
